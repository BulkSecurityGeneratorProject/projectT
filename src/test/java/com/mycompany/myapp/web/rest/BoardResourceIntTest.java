...
public class BoardResourceIntTest {
    ...
    public void createBoard() throws Exception {
        ...
        assertThat(testBoard.getWidth()).isEqualTo(DEFAULT_WIDTH);
        assertThat(testBoard.getHeight()).isEqualTo(DEFAULT_HEIGHT);
    }
    ...
    public void updateBoard() throws Exception {
        ...
        Board testBoard = boardList.get(boardList.size() - 1);
        assertThat(testBoard.getWidth()).isEqualTo(UPDATED_WIDTH);
        assertThat(testBoard.getHeight()).isEqualTo(UPDATED_HEIGHT);
    }
