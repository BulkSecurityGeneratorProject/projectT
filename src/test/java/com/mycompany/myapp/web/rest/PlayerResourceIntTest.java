...
public class PlayerResourceIntTest {
    ...
    private static final PlayerType DEFAULT_TYPE = PlayerType.CROSS;
    private static final PlayerType UPDATED_TYPE = PlayerType.CIRCLE;
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getType()).isEqualTo(DEFAULT_TYPE);
    }
    ...
    public void updatePlayer() throws Exception {
        ...
        assertThat(testPlayer.getType()).isEqualTo(UPDATED_TYPE);
    }
